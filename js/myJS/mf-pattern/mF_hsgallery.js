myFocus.pattern.extend({//*********************hsgallery******************
	'mF_hsgallery':function(settings,$){
		var $focus=$(settings);
		...
		var $dotBox=$focus.find('.dot');
		$dotBox[0].innerHTML='<div class="prev"><a href="javascript:;">&#8249;</a></div>' + $dotBox[0].innerHTML + '<div class="next"><a href="javascript:;">&#8250;</a></div>';
		var $dotList=$dotBox.find('li');
		//var $prevBtn=$focus.addHtml('<div class="prev"><a href="javascript:;">&#8249;</a></div>');
		var $prevBtn=$dotBox.find('.prev');
		//var $nextBtn=$focus.addHtml('<div class="next"><a href="javascript:;">&#8250;</a></div>');
		var $nextBtn=$dotBox.find('.next');
		//CSS
		...
		//$prevBtn[0].style.right=parseInt($dotList[0].style.width)+26+'px';
		//PLAY
...
myFocus.config.extend({'mF_hsgallery':{seamless:true}});//支持无缝设置